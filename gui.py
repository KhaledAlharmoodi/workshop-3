...
class EventOrganizerApp:
    ...
    def create_main_menu(self):
        ...
        for text, command in buttons:
            tk.Button(self.main_menu_frame, text=text, command=command, width=20, height=2, bg="blue",
    ...
    def add_guest(self):
        ...
        tk.Button(content_frame, text="Save", fg="green", bg="black", command=self.save_guest).pack()
    ...
    def add_supplier(self):
        ...
        tk.Button(content_frame, text="Save", fg="green", bg="black", command=self.save_supplier).pack()
